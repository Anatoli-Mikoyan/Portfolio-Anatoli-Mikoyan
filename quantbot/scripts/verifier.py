...
def _conseil_blocage_windows(paquets: list[str]) -> None:
    ...
    print()
    print("  Bonne nouvelle : le verdict de Windows n'est pas définitif. Il repose")
    print("  sur une consultation de réputation en ligne, dont la réponse change")
    print("  avec le temps. Retélécharger le fichier suffit souvent.")
    print()
    print("  Trois pistes, de la moins définitive à la plus définitive :")
    print()
    manquants = " ".join(paquets)
    print("  1. Retélécharger — c'est ce qui marche le plus souvent :")
    print(f"        python -m pip install --force-reinstall --no-cache-dir {manquants}")
    print()
    print("  2. Si le blocage persiste, une version plus ancienne, mieux établie")
    print("     et donc mieux reconnue :")
    print("        python -m pip install \"scipy==1.16.3\"")
    print()
    print("  3. Installer Python 3.12 en parallèle. Les bibliothèques y sont")
    ...
    print()
    print("  En dernier recours seulement — désactiver Smart App Control :")
    ...
    print("     réinstaller Windows. N'y touchez pas avant d'avoir essayé 1, 2 et 3.")
    print()
